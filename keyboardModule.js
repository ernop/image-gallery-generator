(function(){
  const keyboardShortcuts = [
    ...
    {
      keycodes: [33], // pgup
      action: (displayedImageIndex) => displayedImageIndex -= 5,
      type: 'image',
    },
    {
      keycodes: [34], // pgdown
    ...
    {
      keycodes: [35], // end
      action: (displayedImageIndex) => displayedImageIndex = imageUrls.length - 1,
      type: 'image',
    },
    {
      keycodes: [36], // home
      action: (displayedImageIndex) => displayedImageIndex = 0,
      type: 'image',
    },
    {
      keycodes: [37, 38], // left, up
      action: (displayedImageIndex) => displayedImageIndex -= 1,
      type: 'image',
    },
    {
